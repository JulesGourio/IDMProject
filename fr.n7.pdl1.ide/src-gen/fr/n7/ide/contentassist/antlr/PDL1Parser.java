...
public class PDL1Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL1GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getUsedResourcesAssignment_2_1(), "rule__WorkDefinition__UsedResourcesAssignment_2_1");
			builder.put(grammarAccess.getWorkDefinitionAccess().getUsedResourcesAssignment_2_2_1(), "rule__WorkDefinition__UsedResourcesAssignment_2_2_1");
