...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	...
	public EReference getPetriElement_Petrinet() {
		return (EReference)petriElementEClass.getEStructuralFeatures().get(1);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPetriElement_Name(), ecorePackage.getEString(), "name", null, 1, 1, PetriElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getArc_IsReadArc(), ecorePackage.getEBoolean(), "isReadArc", null, 0, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
