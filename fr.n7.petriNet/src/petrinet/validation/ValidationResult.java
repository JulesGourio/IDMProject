 ...
 * Projet : R2.6 - Support de la validation des réseaux de Petri
 * 
...
public class ValidationResult {
	...
	public static class ValidationError {
		...
		public String toString() {
			return "Erreur dans " + PetriNetUtils.guessName(this.object) + ": "
					+ this.error;
		}
	}
	 ...
	 * @param object source de l'erreur (un objet du méta-modèle PetriNet)
	 ...
	 * @param test booléen qui détermine si l'erreur est à enregistrer ou non
	...
	/**
	 * Enregistre une erreur avec un message formaté.
	 * Utile pour les messages d'erreur dynamiques avec des valeurs.
	 * @param object objet source de l'erreur
	 * @param format format du message (style String.format)
	 * @param args arguments pour le formatage
	 */
	public void recordErrorFormatted(EObject object, String format, Object... args) {
		this.recordError(object, String.format(format, args));
	}
	...
	/**
	 * Vérifie si le résultat contient des erreurs.
	 * @return true si aucune erreur n'est enregistrée, false sinon
	 */
	public boolean isValid() {
		return this.recordedErrors.isEmpty();
	}
	...
	public int getErrorCount() {
		return this.recordedErrors.size();
	}
}
