...
public interface PetrinetPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int PETRI_ELEMENT_FEATURE_COUNT = 2;
	 ...
	 * @ordered
	 */
	int NODE__NAME = PETRI_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int NODE__INCOMING = PETRI_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int NODE__OUTGOING = PETRI_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int NODE_FEATURE_COUNT = PETRI_ELEMENT_FEATURE_COUNT + 2;
