...
public interface PDL1Package extends EPackage
{
  ...
  /**
   * Returns the meta object for the reference list '{@link fr.n7.pDL1.WorkDefinition#getUsedResources <em>Used Resources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference list '<em>Used Resources</em>'.
   * @see fr.n7.pDL1.WorkDefinition#getUsedResources()
   * @see #getWorkDefinition()
   * @generated
   */
