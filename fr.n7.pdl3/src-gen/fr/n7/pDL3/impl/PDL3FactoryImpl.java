...
public class PDL3FactoryImpl extends EFactoryImpl implements PDL3Factory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case PDL3Package.WORK_DEFINITION_REF: return createWorkDefinitionRef();
      case PDL3Package.WORK_SEQUENCE_REF: return createWorkSequenceRef();
      case PDL3Package.GUIDANCE_REF: return createGuidanceRef();
      default:
   ...
   */
  @Override
  public WorkDefinitionRef createWorkDefinitionRef()
  {
    WorkDefinitionRefImpl workDefinitionRef = new WorkDefinitionRefImpl();
    return workDefinitionRef;
  }
   ...
   */
  @Override
  public WorkSequenceRef createWorkSequenceRef()
  {
    WorkSequenceRefImpl workSequenceRef = new WorkSequenceRefImpl();
    return workSequenceRef;
  }
   ...
   */
  @Override
  public GuidanceRef createGuidanceRef()
  {
    GuidanceRefImpl guidanceRef = new GuidanceRefImpl();
    return guidanceRef;
  }
