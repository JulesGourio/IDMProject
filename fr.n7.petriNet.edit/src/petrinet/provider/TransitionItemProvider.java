		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_minTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_minTime_feature", "_UI_Transition_type"),
	...
	protected void addMaxTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_maxTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_maxTime_feature", "_UI_Transition_type"),
